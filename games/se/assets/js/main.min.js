...
var _config = {
    ...
    shareData = {
        imgUrl: "http://play.icks018.toptop/games/se/assets/img/find.logo.png",
        timeLineLink: "http://play.icks018.toptop/games/se/",
        tTitle: "看你有多色？",
        tContent: "找出所有色块中颜色不同的一块。分享朋友圈，找到身边的色魔，关注流沙聚社区:viying01"
    };
! function() {
    var a = $("#box"),
        b = {
