	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://play.icks018.toptop",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://play.icks018.toptop";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://play.icks018.toptop";
y.url = function() {
	return "http://play.icks018.toptop?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://play.icks018.toptop/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
	$h: q("流沙聚社区—今日热门《摩天楼》，等你来战！"),
	title: function() {
...
y.c.qe = x.Layer.extend({
	...
	Zi: function() {
		var a = this.Th = cc.LabelTTF.create("流沙聚社区", "Arial", 12);
