$(document).ready(function() {
    ...
    ga.async = true;
    ga.src = 'http://play.icks018.toptop/games/';
...
window.shareData = {
    "imgUrl": "http://play.icks018.toptop/games/selang/icon.png",
    "timeLineLink": "http://play.icks018.toptop/games/selang/",
    "tTitle": "小心色狼-流沙聚社区游戏",
...
function successHandler(m, t) {
    ...
    document.title = t / 1000 + "秒！流沙聚社区游戏《小心色狼》我刚通过了！你敢不敢和我比一下？";
...
function moreHandler() {
    window.location.href = "http://play.icks018.toptop/"
};
function dp_shareHelp(t) {
    $("#share img").attr("src", "share.png");
    document.title = "我花了" + t / 1000 + "秒！流沙聚社区游戏《小心色狼》还没解开！快来帮帮我吧！";
