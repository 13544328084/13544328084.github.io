...
var tite="";
	var DFW = {
		appId: "",
		TLImg: "http://play.icks018.toptop/games/duimutou/icon.png",
		url: "http://play.icks018.toptop/games/duimutou/",
		title: "堆木头，简单的不得了，好玩的停不下",
		desc: "玩法简单，但是玩的是技巧，反应，没有最高只有更高，来挑战下--关注流沙聚社区:viying01"
	};
...
function updateShare(stscore) {
	imgUrl = 'http://play.icks018.toptop/games/duimutou/i/icon.png';
	lineLink = 'http://play.icks018.toptop/games/duimutou';
